        ...
        <section class="profile-number">
          ...
          <router-link :to="userInfo._id ? '/userinfo':'/login'" class="profile-link">
            <div class="profile_image">
              <i class="iconfont icon-person icon-geren"></i>
            </div>
            <div class="user-info">
              ...
              <p>
                ...
                <span class="icon-mobile-number" else>{{userInfo.phone || '暂无绑定手机号'}}</span>
              </p>
            </div>
            <span class="arrow">
              <i class="iconfont icon-jiantou1 icon-icon-jiantou1"></i>
            </span>
          </router-link>
