  ...
  <div class="shop-info">
    <div class="info-content">
      <section class="section">
        <h3 class="section-title"><span class="sx" id="color-blue"></span>配送信息</h3>
        <div class="delivery">
          <div>
      ...
      <section class="section">
        <h3 class="section-title"><span class="sx" id="color-orange"></span>活动与服务</h3>
        <div class="activity">
      ...
      <section class="section">
        <h3 class="section-title"><span class="sx" id="color-black"></span>商家实景</h3>
      ...
      <section class="section">
        <h3 class="section-title"><span class="sx" id="color-green"></span>商家信息</h3>
        <ul class="detail">
          <li><span class="bold">食物品类</span> <span>{{info.category}}</span></li>
          <li><span class="bold">商家电话</span> <span>{{info.phone}}</span></li>
          <li><span class="bold">商家地址</span> <span>{{info.address}}</span></li>
